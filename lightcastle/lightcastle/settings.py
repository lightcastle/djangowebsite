...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('DB_USER'),# os.environ.get("DB_USER", ""),
...
SECRET_KEY = 'zu1&vbzpg_m*28hjh%u%+1pkg81**s79*ay#=1@-issp%-vw6!'
...
ROOT_URLCONF = 'lightcastle.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'lightcastle.wsgi.application'
